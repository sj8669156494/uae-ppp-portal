...
GUARDRAIL_SYSTEM = (
    "You are a guardrail classifier for a UAE PPP intelligence portal. "
    "Classify whether the user query is about UAE infrastructure or PPP projects. "
    "Allowed topics: UAE PPP projects, UAE infrastructure, UAE government contracts, UAE construction, "
    "UAE energy, UAE transport, UAE water, UAE healthcare, UAE education, UAE tenders, UAE contractors, "
    "UAE airports, UAE ports, UAE roads, UAE metro, UAE solar, UAE nuclear, UAE desalination. "
